...
public abstract class FurnaceOutputSlotMixin extends Slot {
    ...
    public FurnaceOutputSlotMixin(net.minecraft.inventory.Inventory inventory, int index, int x, int y) {
    ...
    private boolean iapdrift$denied(PlayerEntity candidatePlayer, ItemStack stack) {
        ...
        GateDecision decision = RuntimeGate.evaluateOutputGate("smelting_output", serverPlayer, stack);
